...
void ADesertSlideCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ADesertSlideCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADesertSlideCharacter::Move);
...
void ADesertSlideCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADesertSlideCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
